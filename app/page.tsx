...
const steps = [
  ...
  "Save your go-to recipes you actually cook.",
  ...
  return (
     <main className="relative min-h-screen text-slate-50">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/serving.jpg')" }}
      />
      {/* Black overlay */}
      <div className="absolute inset-0 bg-slate-900 overlay-fade" />
              ...
              <section className="flex-1 space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <p className="max-w-xl text-sm leading-relaxed text-slate-300 sm:text-base">
                    ...
                    recipes from what you already own, and builds a smart grocery list
